...
if TODAY_STR in [r['date'] for r in live_rows]:
...
# ── Indicators ────────────────────────────────────────────────────
all_rows = lookback_data + [r for r in live_rows if r['date'] != TODAY_STR]
...
if TODAY_STR not in [r['date'] for r in lookback_data]:
